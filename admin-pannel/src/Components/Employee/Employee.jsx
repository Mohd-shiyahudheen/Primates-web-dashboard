...
export default function EnhancedTable({data}) {
  ...
  const deleteTeam = async (d) => {
    try {
      ...
      await axios
        .post(
          `${process.env.REACT_APP_BASE_URL}/api/deleteTeam`,
          obj
        )
        .then((res) =>{
          console.log(res);
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell
                      ...
                      padding="none"
                    >
                      <img src={row.picture} style={{height:"50px",width:"50px"}} alt="" />
                    </TableCell>
                    <TableCell align="left">{row.name}</TableCell>
                    <TableCell align="left">{row.posission}</TableCell>
                    ...
                    <i class='bx bx-trash fs-3' 
                    onClick={() => deleteTeam(row._id)}
                    ></i>
                    </TableCell>
                  </TableRow>
                );
